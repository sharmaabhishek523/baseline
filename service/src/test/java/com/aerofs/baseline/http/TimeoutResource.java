...
@Singleton
@Path("/" + Resources.TIMEOUT_RESOURCE)
public final class TimeoutResource {

    private static final Logger LOGGER = LoggerFactory.getLogger(TimeoutResource.class);

    @GET
    public void poll(@Suspended final AsyncResponse asyncResponse) {
        LOGGER.debug("timeout");

        // wait, but don't do anything
